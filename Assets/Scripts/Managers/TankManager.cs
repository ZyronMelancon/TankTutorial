...
public class TankManager
{
    ...
    public void Setup()
    {
        ...
        m_TankCameraPos = m_Instance.GetComponent<TankCameraPos>();
        ...
        m_TankCameraPos.m_PlayerNumber = m_PlayerNumber;
